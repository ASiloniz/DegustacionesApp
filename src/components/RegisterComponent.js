                        ...
                        <div className='row'>
                            <div className='col-sm-6 col-lg-6'>
                                ...
                                <div className="form-group input-group">
                                    ...
                                    <input name="apellidos" className="form-control" placeholder="Apellidos" type="text" />
                                </div>
                                <div className="form-group input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text"> <i className="fas fa-calendar-week"></i> </span>
                                    </div>
                                    <input name="dateOfBirth" className="form-control" placeholder="" type="date" />
                                </div>
                                <div className="form-group input-group">
                                    <div className="input-group-prepend">
                            ...
                            <div className='col-sm-6 col-lg-6'>
                                ...
                                <div className="form-group input-group" style={{height:'92px'}}>
                                    ...
                                    <textarea name="descripcion" className="form-control" placeholder="Añadir descripción..." type="text" />
                                </div>
                                <div className="form-group input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text"> <i className="far fa-file-alt"></i> </span>
